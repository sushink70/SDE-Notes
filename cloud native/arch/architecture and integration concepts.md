...
1. **Metrics**: Quantitative data (Prometheus, counters/gauges/histograms)
2. **Logs**: Event records (Loki, structured/unstructured)
3. **Traces**: Request paths (Jaeger/Tempo, distributed context)

---

## Diagram 7: GitOps and CI/CD Architecture
...
│                              ▼                                                  │
│  ┌──────────────────────────────────────────────────────────────────── ──────┐  │
│  │                      CI PIPELINE (GitHub Actions/Jenkins/Tekton)          │  │
│  │  ┌──────────────────────────────────────────────────────────────── ────┐  │  │
...
│  │  │     ├─ Unit tests                                                   │  │  │
│  │  │     ├─ Integration tests                                            │  │  │
│  │  │     └─ Security scans (SAST with Semgrep/SonarQube)                 │  │  │
│  │  │                                                                     │  │  │
...
│  │  │     ├─ Commit: "Update myapp to ${SHA}"                             │  │  │
│  │  │     └─ Push to gitops-repo                                          │  │  │
│  │  └─────────────────────────────────────────────────────────────────── ─┘  │  │
│  └───────────────────────────┬──────────────────────────────────────── ──────┘  │
└────────────────────────────────┼────────────────────────────────────────────────┘
                                │
                                │ Pushes manifest changes
                                ▼
┌─────────────────────────────────────────────────────────────────────────────────┐
...
│  │   • Version controlled: all changes are commits                           │  │
...
│  │  │    │                                                              ││  │  │
│  │  │    │ Actions:                                                     ││  │  │
│  │  │    │  • Clones repository at intervals                            ││  │  │
│  │  │    │  • Verifies commit signatures (if configured)                ││  │  │
│  │  │    │  • Makes artifact available to other controllers             ││  │  │
│  │  │    └──────────────────────────────────────────────────────────────┘│  │  │
│  │  │                                                                    │  │  │
...
│  │  │    │   healthChecks:        # Wait for these to be ready          ││  │  │
│  │  │    │     - apiVersion: apps/v1                                    ││  │  │
│  │  │    │       kind: Deployment                                       ││  │  │
│  │  │    │       name: frontend                                         ││  │  │
│  │  │    │                                                              ││  │  │
...
│  │  │    │  • Reports status back to Kustomization resource             ││  │  │
│  │  │    └──────────────────────────────────────────────────────────────┘│  │  │
│  │  │                                                                    │  │  │
│  │  │ 3. Helm Controller                                                 │  │  │
│  │  │    (Similar to Kustomize but for Helm charts)                      │  │  │
│  │  │                                                                    │  │  │
...
│  │  │       • Update status in CRD                                      │  │  │
│  │  │       • Send notifications                                        │  │  │
│  │  │    5. Sleep for interval duration                                 │  │  │
│  │  │                                                                   │  │  │
│  │  │  This ensures cluster state ALWAYS matches Git                    │  │  │
│  │  │  Manual kubectl apply changes get reverted!                       │  │  │
│  │  └───────────────────────────────────────────────────────────────────┘  │  │
│  └─────────────────────────────────────────────────────────────────────────┘  │
│                              │                                                 │
│                              │ Applies manifests                               │
...
│  ┌──────────────────────────────────────────────────────────────────────────┐  │
│  │                    Kubernetes API Server                                 │  │
│  │  • Receives manifest applications from Flux                              │  │
│  │  • Creates/Updates/Deletes resources                                     │  │
│  │  • Standard Kubernetes controllers act on resources                      │  │
│  └──────────────────────────────────────────────────────────────────────────┘  │
└────────────────────────────────────────────────────────────────────────────────┘
...
│  │  │   analysis:                                                        │  │  │
│  │  │     interval: 1m                                                   │  │  │
│  │  │     threshold: 5          # Number of failed checks to rollback   │  │  │
...
│  │  │                                                                   │  │  │
│  │  │ 1. New version deployed (image updated in Git)                    │  │  │
│  │  │    Flux applies → Deployment updated                              │  │  │
│  │  │                                                                   │  │  │
│  │  │ 2. Flagger detects change                                         │  │  │
│  │  │    • Creates canary deployment (frontend-canary)                  │  │  │
│  │  │    • Waits for canary pods to be ready                            │  │  │
│  │  │                                                                   │  │  │
│  │  │ 3. Traffic shifting (using Istio/Linkerd/nginx):                  │  │  │
│  │  │    ┌─────────────────────────────────────────────────────┐        │  │  │
│  │  │    │ Time    │ Primary │ Canary │ Metrics Check          │        │  │  │
│  │  │    ├─────────┼─────────┼────────┼────────────────────────┤        │  │  │
│  │  │    │ 0min    │ 100%    │  0%    │ Initialization         │        │  │  │
│  │  │    │ 1min    │  90%    │ 10%    │ ✓ Success rate: 99.5%  │        │  │  │
│  │  │    │ 2min    │  80%    │ 20%    │ ✓ Latency: 450ms       │        │  │  │
│  │  │    │ 3min    │  70%    │ 30%    │ ✓ All metrics pass     │        │  │  │
│  │  │    │ 4min    │  60%    │ 40%    │ ✓ Continuing...        │        │  │  │
│  │  │    │ 5min    │  50%    │ 50%    │ ✓ Max weight reached   │        │  │  │
│  │  │    │ 6min    │   0%    │100%    │ Promotion!             │        │  │  │
│  │  │    └─────────────────────────────────────────────────────┘        │  │  │
│  │  │                                                                   │  │  │
│  │  │ 4. Promotion:                                                     │  │  │
│  │  │    • Primary deployment updated to canary version                 │  │  │
│  │  │    • Canary deployment scaled to zero                             │  │  │
│  │  │    • Traffic fully on new version                                 │  │  │
│  │  │                                                                   │  │  │
│  │  │ 5. Rollback (if metrics fail):                                    │  │  │
│  │  │    • Traffic immediately shifted to 100% primary                  │  │  │
...
┌─────────────────────────────────────────────────────────────────────┐
│  Scenario: Someone runs kubectl apply directly                      │
│                                                                     │
│  1. Manual change:                                                  │
│     kubectl scale deployment frontend --replicas=10                 │
│     (Git says 3 replicas, cluster now has 10)                       │
│                                                                     │
│  2. Next reconciliation (within 10 minutes):                        │
│     Flux: "Desired state (Git): 3 replicas"                         │
│     Flux: "Actual state (Cluster): 10 replicas"                     │
│     Flux: "DRIFT DETECTED - Taking corrective action"               │
│                                                                     │
│  3. Remediation:                                                    │
...
│                                                                     │
│  4. Notification:                                                   │
│     "Drift detected and corrected in production/frontend"           │
│     Sent to Slack with details of what changed                      │
│                                                                     │
│  Key Point: Git is the ONLY way to make lasting changes!            │
└─────────────────────────────────────────────────────────────────────┘
```

**GitOps Benefits:**
1. **Declarative**: Describe what you want, not how to get there
2. **Versioned**: Every change is a Git commit with full history
3. **Automated**: No manual kubectl commands in production
4. **Auditable**: Git log shows who changed what and when
5. **Recoverable**: Roll back by reverting Git commits

---

## Diagram 8: Security Architecture - Multi-Layer Defense
...
│  │                                                                           │  │
│  │  ┌─────────────────────────────────────────────────────────────── ─────┐  │  │
│  │  │ Container Image Build (CI Pipeline)                                 │  │  │
│  │  │                                                                     │  │  │
...
│  │  │                                                                    │  │  │
│  │  │  Cosign Signing:                                                   │  │  │
│  │  │   • Generates signature of image                                   │  │  │
│  │  │   • Stores signature in registry (OCI artifact)                    │  │  │
│  │  │   • Uses Sigstore for keyless signing                              │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  │                                                                          │  │
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
│  │  │ SBOM (Software Bill of Materials) Generation                       │  │  │
│  │  │  • Syft generates SBOM listing all dependencies                    │  │  │
...
│  │  │  │       ↓                                                       │  │  │  │
│  │  │  │  MutatingWebhooks (can modify request)                        │  │  │  │
│  │  │  │       ↓                                                       │  │  │  │
│  │  │  │  ValidatingWebhooks (accept or reject)                        │  │  │  │
│  │  │  │       ↓                                                       │  │  │  │
...
│  │                                                                           │  │
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
│  │  │ Image Signature Verification (Sigstore Policy Controller)          │  │  │
│  │  │  • Intercepts image pulls                                          │  │  │
│  │  │  • Verifies Cosign signature exists                                │  │  │
│  │  │  • Checks signature against public key/Fulcio                      │  │  │
│  │  │  • Rejects unsigned or invalidly signed images                     │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  └──────────────────────────────────────────────────────────────────────────┘  │
│                              │                                                 │
│                              │ Pod admitted                                    │
...
│  │  │  │    File: /etc/shadow, /etc/passwd accessed                   │  │  │  │
│  │  │  │    Alert: Unauthorized access attempt                        │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ 3. Unexpected Network Connection:                            │  │  │  │
│  │  │  │    Container connects to unknown IP                          │  │  │  │
│  │  │  │    Alert with source/dest details                            │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ 4. Privilege Escalation:                                     │  │  │  │
│  │  │  │    setuid/setgid syscalls detected                           │  │  │  │
│  │  │  │    Alert: Potential privilege escalation                     │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ 5. Container Drift:                                          │  │  │  │
│  │  │  │    Binary executed not in original image                     │  │  │  │
│  │  │  │    Alert: Possible container compromise                      │  │  │  │
│  │  │  └──────────────────────────────────────────────────────────────┘  │  │  │
│  │  │                                                                    │  │  │
│  │  │  eBPF Programs Monitor:                                            │  │  │
...
│  │                                                                          │  │
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
│  │  │ KubeArmor - Runtime Policy Enforcement (eBPF LSM)                  │  │  │
│  │  │  ┌──────────────────────────────────────────────────────────────┐  │  │  │
│  │  │  │ KubeArmorPolicy Example:                                     │  │  │  │
│  │  │  │                                                              │  │  │  │
...
│  │  │  │     action: Block                                            │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ Result: eBPF blocks execution at LSM hook                    │  │  │  │
│  │  │  │         Returns EPERM before process starts                  │  │  │  │
│  │  │  └──────────────────────────────────────────────────────────────┘  │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  └──────────────────────────────────────────────────────────────────────────┘  │
│                                                                                │
...
│  │  │  │           port: 53                                           │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ Enforced by CNI (Cilium/Calico) via eBPF or iptables         │  │  │  │
│  │  │  └──────────────────────────────────────────────────────────────┘  │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  │                                                                          │  │
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
...
│  │  │  • Identity verified via SPIFFE certificates                       │  │  │
│  │  │  • Certificate rotation automated (every 24h)                      │  │  │
...
│  │  │  │                                                              │  │  │  │
│  │  │  │ Flow:                                                        │  │  │  │
│  │  │  │  1. Operator watches ExternalSecret                          │  │  │  │
│  │  │  │  2. Fetches from Vault/AWS Secrets Manager/GCP Secret Mgr    │  │  │  │
│  │  │  │  3. Creates/Updates Kubernetes Secret                        │  │  │  │
│  │  │  │  4. Refreshes periodically                                   │  │  │  │
│  │  │  │                                                              │  │  │  │
│  │  │  │ Benefits:                                                    │  │  │  │
...
│  │  │   • Can: create/update pods, services, deployments in dev NS       │  │  │
│  │  │   • Cannot: delete pods, access prod NS, modify RBAC               │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  │                                                                          │  │
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
│  │  │ Service Mesh Authorization (Istio)                                 │  │  │
│  │  │  AuthorizationPolicy enforces L7 access control                    │  │  │
│  │  │   • Based on service identity (SPIFFE)                             │  │  │
│  │  │   • Can match on HTTP methods, paths, headers                      │  │  │
│  │  │   • Much finer-grained than NetworkPolicy                          │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  └──────────────────────────────────────────────────────────────────────────┘  │
│                                                                                │
...
│  │  ┌────────────────────────────────────────────────────────────────────┐  │  │
│  │  │ cert-manager                                                       │  │  │
│  │  │  • Automates TLS certificate provisioning                          │  │  │
│  │  │  • Let's Encrypt integration (ACME protocol)                       │  │  │
│  │  │  • Automatic renewal (30 days before expiry)                       │  │  │
│  │  │  • Private CA support                                              │  │  │
│  │  │  • Used by Ingress, service mesh, webhooks                         │  │  │
│  │  └────────────────────────────────────────────────────────────────────┘  │  │
│  └──────────────────────────────────────────────────────────────────────────┘  │
└────────────────────────────────────────────────────────────────────────────────┘
...
┌─────────────────────────────────────────────────────────────────────┐
│  Multi-Layer Detection Example:                                     │
│                                                                     │
│  Scenario: Attacker exploits vulnerability to get shell             │
│                                                                     │
│  Layer 1 (Supply Chain):                                            │
│   ✗ Failed: Vulnerable image not caught (zero-day)                  │
│                                                                     │
│  Layer 2 (Admission):                                               │
│   ✓ Passed: Image signed, policies enforced                         │
│   (But vulnerability was unknown)                                   │
│                                                                     │
│  Layer 3 (Runtime):                                                 │
│   🚨 Falco Alert: "Shell spawned in container webapp-xyz"           │
│   🚨 KubeArmor: Blocked attempt to exec /bin/bash                   │
│   (Attacker can't get interactive shell!)                           │
│                                                                     │
│  Layer 4 (Network):                                                 │
│   🚨 NetworkPolicy blocks egress to attacker's C2 server            │
│   (Even if shell executed, can't exfiltrate data)                   │
│                                                                     │
│  Result: Multi-layer defense prevented breach!                      │
│  Action: Incident response team investigates, patches app           │
└─────────────────────────────────────────────────────────────────────┘
```

**Defense in Depth Strategy:**
- **No single point of failure**: Multiple security layers
- **Assume breach**: Design for when (not if) compromise happens
- **Detect & respond**: Runtime monitoring catches what admission control misses
- **Least privilege**: Minimize blast radius of any compromise
- **Automation**: Manual security doesn't scale

---

This comprehensive set of diagrams covers the entire cloud native architecture from container runtimes through Kubernetes networking, eBPF, service mesh, observability, GitOps, and security. Each diagram shows not just the components but the actual data flows, decision points, and how systems interact at a deep technical level.

The key takeaway is that modern cloud native systems are **highly integrated** - CNI plugins work with eBPF, service meshes integrate with observability tools, GitOps coordinates with progressive delivery, and security operates at every layer. Understanding these interactions is crucial for operating Kubernetes successfully at scale.